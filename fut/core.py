...
class Core(object):
    def __init__(self, email, passwd, secret_answer, platform='ps4', code=None, emulate=None, debug=False, cookies=cookies_file):
        self.credits = 0
    ...
    def __login__(self, email, passwd, secret_answer, platform='ps4', code=None, emulate=None):
        """Log in.
...
#        # self.r.headers['X-UT-Route'] = self.urls['fut_pc']
    ...
    def searchAuctions(self, ctype, level=None, category=None, assetId=None, defId=None,
        ...
        :param ctype: [development / player / ?] Card type.
